...
public class BoardDaoImpl implements BoardDao {
    ...
    public List<Board> allBoards() {
        return  jdbcTemplate.query(GET_BOARDS_QUERY, (rs, rowNum) -> new Board(rs.getInt("id"),rs.getString("name")));
    }


    @Override
    public Board getById(int id) {
        return jdbcTemplate.queryForObject(GET_BOARD_BY_ID_QUERY, (rs, rowNum) -> new Board(rs.getInt("id"),rs.getString("name")), id);
    }
